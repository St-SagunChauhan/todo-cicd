...
import { IMasterReportActionType } from 'models/IMasterReport';
...
class MasterReportService {
  fetchmasterbillingReport = (startDate?: string, currentDate?: string, dept?: string | null) => (dispatch: Dispatch<any>) => {
    dispatch({
