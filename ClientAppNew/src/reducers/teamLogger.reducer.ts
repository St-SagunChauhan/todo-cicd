import { ITeamLoggerActionCreator, ITeamLoggerActionTypes, ITeamLoggerState } from 'models/ITeamLogger';
...
const reducer = (state = initialState, { type, payload }: ITeamLoggerActionCreator) => {
  switch (type) {
